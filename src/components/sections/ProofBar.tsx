...
function ClaudeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="#D97757">
      <path d="M4.709 15.955l4.72-2.756.08-.046 2.803-1.636a.474.474 0 00-.093-.874l-7.1-2.585a.5.5 0 00-.69.496l.165 6.873a.5.5 0 00.115.528zm6.997-.627l-4.476 2.58a.5.5 0 00.043.878l6.741 3.005a.5.5 0 00.686-.365l1.16-6.737a.474.474 0 00-.56-.55l-3.195.762a.25.25 0 01-.084.007zm1.88-4.093l3.547-.77a.474.474 0 00.305-.752L12.075 3.7a.5.5 0 00-.82.073L8.09 9.627a.5.5 0 00.348.722z" />
    </svg>
  );
}
