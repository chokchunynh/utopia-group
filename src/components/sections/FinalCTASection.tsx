        ...
        <div className="section-inner text-center">
          <ScrollReveal>
            <h2 className="heading-display text-[28px] md:text-[44px] mb-4">
              Your competitors are already implementing AI.
              <br />
              <span className="text-[var(--color-brand)]">Are you?</span>
            </h2>
            <p className="text-[var(--color-text-muted)] mb-8 max-w-md mx-auto text-[15px]">
              One WhatsApp message. We&apos;ll tell you exactly where AI can
              improve your business. No pitch. Just answers.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
