...
export const DEPARTMENTS = [
  ...
  },
  {
    ...
    icon: "megaphone",
    tools: [
      { name: "AutoViral", url: "https://autopost-web-amber.vercel.app", logo: "/images/client-logos/autoviral-icon.svg", desc: "AI generates and schedules social media content across all platforms. One click for a month of posts." },
