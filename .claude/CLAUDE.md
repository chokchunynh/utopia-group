...
- 2026-03-29 (session 4): Nav polish: Home link added, Results removed (duplicate). Fixed desktop More dropdown hover gap. Flattened mobile More (Masterclass children as direct links with full labels). Logo grid cyan-50 bg + mobile truncation. Career hero overlay darkened. 9 commits. Deployed.
